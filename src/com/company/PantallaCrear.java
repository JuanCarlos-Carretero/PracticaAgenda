...
public class PantallaCrear {
    void mostrar() {
        ...
        Main.db.insertContacto(contacto.nombre, contacto.apellido1, contacto.apellido2, contacto.grupo, contacto.nTelefono, contacto.eMail, contacto.direccion, contacto.fechaCumpleanyos);
